...
predict(SpamTestPCA) # with 43 principal components I can explain the 90% of the variance. I have 57 variables, meaning I have 57 PCs
## the 1st principle component is the most relevant, and all the other come in a descending way
...
lmRoc
## area under the curve is 0.9711, it is pretty good

trctrlWithPCA <- trainControl(method = "none", preProcOptions = list(thresh=0.5)) # treshold - what ratio of variables it can keep
## 0.5 means it can use/keep 50% of the principal components
